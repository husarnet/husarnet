...
IDF_PATH_DIR = os.environ.get('IDF_PATH')
if os.path.join(IDF_PATH_DIR, 'tools', 'ci') not in sys.path:
    sys.path.append(os.path.join(IDF_PATH_DIR, 'tools', 'ci'))

if os.path.join(IDF_PATH_DIR, 'tools', 'ci', 'python_packages') not in sys.path:
    sys.path.append(os.path.join(IDF_PATH_DIR, 'tools', 'ci', 'python_packages'))
...
def pytest_addoption(parser: pytest.Parser) -> None:
    ...
    parser.addoption('--joincode', help='Husarnet join code')

@pytest.fixture
def join_code(request):
    return request.config.getoption("--joincode")
