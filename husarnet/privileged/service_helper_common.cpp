...
void parseHostsFile(std::ifstream& input,
...
bool updateHostsFileInternal(
  ...
  // Note: renameOrCopyFile will leave the tmp file on the filesystem if rename
  // is not possible but as it's name is stable this shouldn't do much harm
