...
if(${CMAKE_SYSTEM_NAME} STREQUAL Linux)
  ...
  list(APPEND husarnet_core_include_DIRS ${CMAKE_CURRENT_LIST_DIR}/husarnet/ports/unix)
  ...
  file(GLOB port_unix_SRC "${CMAKE_CURRENT_LIST_DIR}/husarnet/ports/unix/*.cpp")
