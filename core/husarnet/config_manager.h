...
#define STATUS_KEY_ENVIRONMENT_HOOKS_ENABLED "hooks_enabled"
#define STATUS_KEY_ENVIRONMENT_DAEMON_API_HOST "daemon_api_host"
#define STATUS_KEY_ENVIRONMENT_DAEMON_API_PORT "daemon_api_port"
