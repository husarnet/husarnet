 ...
 */
typedef _Return_type_success_(return != FALSE) BOOL(WINAPI WINTUN_DELETE_DRIVER_FUNC)(VOID);
 ...
 */
typedef _Return_type_success_(return != 0) DWORD(WINAPI WINTUN_GET_RUNNING_DRIVER_VERSION_FUNC)(VOID);
 ...
 */
typedef VOID(
    CALLBACK* WINTUN_LOGGER_CALLBACK)(_In_ WINTUN_LOGGER_LEVEL Level, _In_ DWORD64 Timestamp, _In_z_ LPCWSTR Message);
 ...
 */
typedef _Must_inspect_result_ _Return_type_success_(return != NULL) _Post_maybenull_ _Post_writable_byte_size_(
    *PacketSize) BYTE*(WINAPI WINTUN_RECEIVE_PACKET_FUNC)(_In_ WINTUN_SESSION_HANDLE Session, _Out_ DWORD* PacketSize);
 ...
 */
typedef _Must_inspect_result_ _Return_type_success_(return != NULL) _Post_maybenull_
    _Post_writable_byte_size_(PacketSize) BYTE*(
