...
class HusarnetJsonSink : public HusarnetSink
{
                                     ...
                                     std::string_view log_message, std::string_view log_statement) override
  {
    ...
    _message.append(fmtquill::format(R"({{"timestamp":"{}","log_level":"{}","message":"{}")",
    ...
    StreamSink::write_log(log_metadata, log_timestamp, thread_id, thread_name, process_id, logger_name, log_level,
                          ...
                          std::string_view{_message.data(), _message.size()});
...
class HusarnetNoJsonSink : public HusarnetSink
{
                                     ...
                                     std::string_view log_message, std::string_view log_statement) override
  {
    ...
    StreamSink::write_log(log_metadata, log_timestamp, thread_id, thread_name, process_id,
                          ...
                          named_args, msg, std::string_view{stmt.data(), stmt.size()});
  }
};
