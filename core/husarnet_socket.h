...
void husarnet_sockets_init(const char* identity,
                           bool secure,
...
int husarnet_setsockopt(int fd,
                        int level,
                        int optname,
                        void* optval,
                        socklen_t optlen);
int husarnet_recv(int fd, void* buf, size_t len, int flags);
int husarnet_recvfrom(int fd,
                      void* buf,
                      size_t len,
                      int flags,
